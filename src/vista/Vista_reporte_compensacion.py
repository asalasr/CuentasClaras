...
class Vista_reporte_compensacion(QWidget):
    ...
    def mostrar_reporte_compensacion(self, matriz_compensacion,actividad_Seleccionada):
        """
        Esta función construye el reporte de compensación a partir de una matriz
        """        
        print("llego aqui")
        self.matriz = matriz_compensacion
        self.actividad_Seleccionada = actividad_Seleccionada
    ...
    def volver(self):
        ...
        """   
        self.hide()
        print("idactividad en compensacion"+str(self.actividad_Seleccionada))
        self.interfaz.mostrar_actividad(self.actividad_Seleccionada)
